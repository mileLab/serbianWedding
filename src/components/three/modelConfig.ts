 ...
 *
 * Right now every scene (`PeskirScene`, `ProductPlatform`) renders a
 * hand-tuned procedural fallback built from primitives + shaders, so the
 * site works with zero external assets.
 *
 ...
 *     for `USE_GLTF_MODELS` in PeskirScene.tsx / ProductPlatform.tsx.
 */
